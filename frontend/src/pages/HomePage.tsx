                ...
                {articles.map((article) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <time className="text-xs text-[var(--text-secondary)]" dateTime={article.createdAt}>{formatRelativeTime(article.createdAt)}</time>
                    </div>
                ...
                {moments.map((moment) => (
                  <article key={moment.id} className="card p-4" role="listitem">
                    ...
                    <div className="flex items-center justify-between text-xs text-[var(--text-secondary)]">
                      <time>{formatRelativeTime(moment.createdAt)}</time>
