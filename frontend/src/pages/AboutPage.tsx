...
const AboutPage: FC = () => {
  ...
  const timeline = [
    { year: '2024', title: '开始搭建个人博客', description: '使用 React + TypeScript + Tailwind CSS 搭建了这个博客' },
    { year: '2023', title: '深入学习前端技术', description: '专注于 React 生态系统，学习 TypeScript 和现代前端工具链' },
    { year: '2022', title: '开始学习编程', description: '从零开始学习编程，发现了对前端开发的热爱' },
  ];
      ...
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="card p-8 mb-8">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <img src="/logo.png" alt="avatar" className="w-32 h-32 object-contain" />
            <div className="text-center md:text-left">
              <h1 className="text-3xl font-bold text-[var(--text-primary)] mb-2">oolongho</h1>
            ...
            <div className="space-y-8">
              {timeline.map((item, index) => (
                <div key={index} className="relative pl-12">
                  <div className="absolute left-2 w-5 h-5 bg-primary rounded-full border-4 border-[var(--card-bg)]" />
